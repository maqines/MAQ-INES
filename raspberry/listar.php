...
<body>
<table width="1328" height="149" border="1" align="center" cellpadding="1" cellspacing="1">
<tr>
<td colspan="14"><strong class="Estilo3 Estilo6">LISTADO DE REGISTROS </strong></td>
</tr>
...
$registros=mysql_query("select id,ids,valor,valor1,fecha from valores as val
                       inner join valores1 as val1 on val1.ids=val.id",$conexion) or
